...
4. [[black|Black]]
5. [[isort|isort]]
6. [[pre-commit|Pre-commit Hooks]]
7. [[makefile-python|Makefiles for Python Projects]]
8. [[profiling-python|Profiling Python Code]]
9. [[debugging-python|Debugging Python]]
...
3. [[ci-testing-pipeline|CI Testing Pipeline]]
4. [[cd-docker|CD with Docker]]
